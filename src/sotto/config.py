...
# turbo — preview lag stays low, at the cost of some accuracy).
...
# Small multilingual models to experiment with for streaming (larger = more
# accurate, slower per phrase).
